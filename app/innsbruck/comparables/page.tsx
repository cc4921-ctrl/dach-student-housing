...
const pbsa = [
  {
    ...
    operator: "Home4students", beds: "~120", location: "Höttinger Au",
    rooms: [
      { type: "Single Room", price: "€505/mo" },
      { type: "Shared Room", price: "€320/mo" },
    ],
  },
  {
    name: "Home4students Technikerstraße 7", category: "University Subsidised" as Category,
    operator: "Home4students", beds: "~100", location: "Technik campus",
    rooms: [
      { type: "Single Room", price: "€455/mo" },
      { type: "Shared Room", price: "€310/mo" },
    ],
  },
  {
  ...
  {
    name: "Studentenheim Saggen", category: "University Subsidised" as Category,
    operator: "Various", beds: "~60", location: "Saggen",
    rooms: [
      { type: "Single Room", price: "€400–€450/mo" },
  ...
  },
  {
    ...
    rooms: [
      { type: "Standard Single", price: "€425/mo" },
      { type: "Premium Single", price: "€535/mo" },
    ],
  },
  {
    name: "STUWO Raimund Pradler", category: "Premium PBSA" as Category,
    operator: "STUWO", beds: "~150", location: "Pradl",
    rooms: [
      { type: "Single Room (ensuite)", price: "€789/mo" },
      { type: "Shared Room (ensuite)", price: "€729/mo" },
    ],
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-6 py-6">
          ...
          <p className="text-slate-500 mt-1">Innsbruck &middot; 6 properties &middot; ~710 beds</p>
        </div>
      </header>
