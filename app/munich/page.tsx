    ...
    <div className="min-h-screen bg-midnight">
      ...
      <div className="relative w-full h-44 overflow-hidden bg-midnight-light">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-5xl mx-auto px-6 pb-8">
          ...
          <h1 className="text-3xl font-serif text-snow tracking-tight">Munich</h1>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/munich/comparables" className="inline-flex items-center justify-center gap-2 bg-emerald-accent text-midnight px-6 py-3 rounded-xl hover:bg-emerald-glow transition-colors font-bold text-sm tracking-wide">
            PBSA Comparables &rarr;
          </Link>
          <Link href="/munich/universities" className="inline-flex items-center justify-center gap-2 bg-transparent text-silver border border-white/[0.1] px-6 py-3 rounded-xl hover:text-snow hover:border-white/[0.2] transition-all font-medium text-sm">
            Universities
          </Link>
