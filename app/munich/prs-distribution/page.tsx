...
export default function MunichPRSPage() {
  return (
    <div className="min-h-screen bg-midnight">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/munich" className="group inline-flex items-center justify-center gap-3 bg-emerald-accent text-midnight px-6 py-3 rounded-xl hover:bg-emerald-glow transition-colors font-bold text-sm tracking-wide">
