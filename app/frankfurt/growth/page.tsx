...
const rentHistory = [
  { year: "2020", pbsaAvg: 520, premiumPbsa: 780, prsMedian: 620, prsSqm: 16.8 },
  { year: "2021", pbsaAvg: 550, premiumPbsa: 820, prsMedian: 660, prsSqm: 17.6 },
  { year: "2022", pbsaAvg: 590, premiumPbsa: 880, prsMedian: 710, prsSqm: 18.9 },
  { year: "2023", pbsaAvg: 630, premiumPbsa: 950, prsMedian: 740, prsSqm: 20.1 },
  { year: "2024", pbsaAvg: 660, premiumPbsa: 1010, prsMedian: 760, prsSqm: 21.2 },
  { year: "2025", pbsaAvg: 680, premiumPbsa: 1050, prsMedian: 780, prsSqm: 22.4 },
];

const spreadHistory = [
  { year: "2020", prsVsPbsa: 100, premiumVsPrs: 160, prsVsStudentenwerk: 310 },
  { year: "2021", prsVsPbsa: 110, premiumVsPrs: 160, prsVsStudentenwerk: 350 },
  { year: "2022", prsVsPbsa: 120, premiumVsPrs: 170, prsVsStudentenwerk: 400 },
  { year: "2023", prsVsPbsa: 110, premiumVsPrs: 210, prsVsStudentenwerk: 430 },
  { year: "2024", prsVsPbsa: 100, premiumVsPrs: 250, prsVsStudentenwerk: 450 },
  { year: "2025", prsVsPbsa: 100, premiumVsPrs: 270, prsVsStudentenwerk: 470 },
];

const bedSupplyHistory = [
  { year: "2020", beds: 4800, provisionRate: "7.1%" },
  { year: "2021", beds: 5000, provisionRate: "7.2%" },
  { year: "2022", beds: 5100, provisionRate: "7.3%" },
  { year: "2023", beds: 5200, provisionRate: "7.4%" },
  { year: "2024", beds: 5400, provisionRate: "7.5%" },
  { year: "2025E", beds: 5500, provisionRate: "7.6%" },
  { year: "2028E", beds: 6700, provisionRate: "~9.3%" },
];

const keyTakeaways = [
  "PRS rents have grown ~26% since 2020 (€620 → €780/mo). PBSA rents grew ~31% (€520 → €680/mo) — PBSA catching up to private market as operators enter the Frankfurt market.",
  "Frankfurt's PBSA market is still maturing: average PBSA rents sit €100/mo below PRS median, offering genuine value for students — particularly those from international finance and business programmes.",
  "Premium PBSA rents (€1,050/mo) command a €270 premium over PRS median — a 35% markup driven by prime Europaviertel locations and all-inclusive amenity packages.",
  "PRS rent per sqm grew from €16.80 to €22.40 (+33%), consistent with Frankfurt's tightening rental market as the city attracts more ECB/finance-sector workers.",
  "Provision rate has inched from 7.1% to 7.6% over five years despite ~700 new beds. Pipeline of ~1,200 beds could lift this to ~9.3% by 2028 — still well below German average of ~10%.",
];

const summaryStats = [
  { label: "Students (2024/25)", value: "~72,000" },
  { label: "Intl Students", value: "~20%" },
  { label: "City Population", value: "~773K" },
  { label: "PBSA Beds", value: "~5,500" },
];
...
export default function FrankfurtGrowthPage() {
  return (
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-midnight-light border border-white/[0.06] rounded-xl p-4">
              ...
              <div className="text-2xl font-bold text-snow font-serif">€680<span className="text-xs text-silver/40 font-sans font-normal ml-1">/mo</span></div>
            ...
            <div className="bg-midnight-light border border-white/[0.06] rounded-xl p-4">
              ...
              <div className="text-2xl font-bold text-snow font-serif">€1,050<span className="text-xs text-silver/40 font-sans font-normal ml-1">/mo</span></div>
              <div className="text-[11px] text-emerald-accent mt-1">+35% since 2020</div>
            </div>
            <div className="bg-midnight-light border border-white/[0.06] rounded-xl p-4">
              <div className="text-[10px] text-silver/50 uppercase tracking-wider mb-1.5">PRS Median</div>
              <div className="text-2xl font-bold text-snow font-serif">€780<span className="text-xs text-silver/40 font-sans font-normal ml-1">/mo</span></div>
              <div className="text-[11px] text-cat-amber mt-1">+26% since 2020</div>
            </div>
            <div className="bg-midnight-light border border-white/[0.06] rounded-xl p-4">
              <div className="text-[10px] text-silver/50 uppercase tracking-wider mb-1.5">PRS €/sqm</div>
              <div className="text-2xl font-bold text-snow font-serif">€22.40<span className="text-xs text-silver/40 font-sans font-normal ml-1">/sqm</span></div>
        ...
        <section>
          ...
          <div className="bg-midnight-light border border-white/[0.06] rounded-2xl p-6">
            ...
            <p className="text-xs text-silver/40 mt-4">CAGR (2020–2025): Avg PBSA ~5.5% · Premium PBSA ~6.1% · PRS Median ~4.7% · PRS €/sqm ~5.9%</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-midnight-light border border-white/[0.06] rounded-2xl p-6 space-y-4">
            {rentHistory.map((row) => (
              <DualBarRow key={row.year} year={row.year} val1={row.pbsaAvg} val2={row.prsMedian} max={1000} label1="PBSA" label2="PRS" color1="bg-emerald-accent/60" color2="bg-cat-amber/60" />
            ))}
            ...
            <p className="text-xs text-silver/40">PBSA rents sit below PRS median, reflecting Frankfurt&rsquo;s still-maturing PBSA operator market with room for premium positioning.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-midnight-light border border-white/[0.06] rounded-2xl p-6">
            ...
            <p className="text-xs text-silver/40 mt-4">PRS–Studentenwerk spread has grown from €310 to €470/mo (+52%), underscoring the widening affordability gap for students relying on private rentals.</p>
          </div>
        </section>
