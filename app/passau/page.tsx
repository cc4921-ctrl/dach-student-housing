        ...
        <section>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 pb-4">
            ...
            <div className="mt-5 pt-4 border-t border-slate-100 flex flex-wrap items-center gap-6 text-sm text-slate-500">
              <div>Median <span className="font-semibold text-slate-800">&euro;490</span></div>
              <div>Q25 <span className="font-semibold text-slate-800">&euro;420</span></div>
              <div>Q75 <span className="font-semibold text-slate-800">&euro;530</span></div>
              <div>Range <span className="font-semibold text-slate-800">&euro;332&ndash;&euro;650</span></div>
            </div>
          </div>
        </section>
